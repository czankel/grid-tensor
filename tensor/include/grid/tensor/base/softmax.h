...
class TensorSoftMax<Tensor, _Tp, _Rank, _Tensor>
{
 public:
 ...
 public:
  ...
  auto operator()() const requires (std::is_floating_point_v<value_type>)
  {
    ...
    return TensorMul(result, Tensor{scale})();
  }
...
TensorSoftMax(_Tensor)
  -> TensorSoftMax<Tensor, typename _Tensor::value_type, _Tensor::rank, typename to_tensor<_Tensor>::type>;
