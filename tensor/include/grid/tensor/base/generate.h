...
#ifndef GRID_TENSOR_BASE_GENERATE_H
#define GRID_TENSOR_BASE_GENERATE_H
...
/// @brief GenerateOperator provides helper for applying a generator on a tensor.
///
/// GenerateOperator is a class that provides overloaded operator() for applying a
...
template <> class GenerateOperator<device::Base>
{
...
#endif  // GRID_TENSOR_BASE_GENERATE_H
