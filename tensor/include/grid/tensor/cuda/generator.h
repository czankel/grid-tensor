...
#ifndef GRID_TENSOR_CUDA_GENERATOR_H
#define GRID_TENSOR_CUDA_GENERATOR_H
...
/// @brief GeneratorOperator provides helper for applying a generator on a tensor.
template <template <typename> typename TOperator>
class GeneratorOperator<TOperator, device::Cuda>
{
...
#endif  // GRID_TENSOR_CUDA_GENERATOR_H
