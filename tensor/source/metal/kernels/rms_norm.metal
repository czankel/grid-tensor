...
[[kernel]] void RmsNormLine(const device T* x,
                            ...
                            __attribute__((unused)) uint line_size [[threads_per_threadgroup]], //// FIXME Rank2/Looped/...
                            ...
                            uint simd_group_id [[simdgroup_index_in_threadgroup]])
{
  ...
  if (lid * N_READS + N_READS <= dim)
  {
    ...
    {
      float xi = x[i];  // FIXME: extra line needed?
      acc += xi * xi;
    }
  }
  else
...
[[kernel]] void RmsNormLoop(const device T* x,
                            ...
                            uint gid [[threadgroup_position_in_grid]],
                            uint lid [[thread_position_in_threadgroup]],
                            uint line_size [[threads_per_threadgroup]], //// FIXME Rank2/Looped/...
                            uint simd_lane_id [[thread_index_in_simdgroup]],
                            uint simd_group_id [[simdgroup_index_in_threadgroup]])
{
  float acc = 0; // FIXME T acc?
