...
TYPED_TEST_P(UnaryTestSuite, TensorUnaryRank0)
{
...
TYPED_TEST_P(UnaryTestSuite, TensorUnaryRank1)
{
...
TYPED_TEST_P(UnaryTestSuite, TensorUnaryRank2)
{
  typename TypeParam::Tensor tensor = grid::Tensor{ {11, 22}, {33, 44}, {55, 66} };
...
TYPED_TEST_P(UnaryTestSuite, TensorUnaryRank3)
{
